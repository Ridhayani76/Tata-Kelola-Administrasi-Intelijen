...
class CatatanWawancaraCRUDDataRowAdded extends Seeder
{
    /**
        ...
        try {
            ...
            \DB::table('badaso_data_rows')->insert(array (
                ...
                array (
                    ...
                    'delete' => 1,
                    'details' => '{}',
                    'relation' => '{"destination_table":"surat_perintah_operasi","destination_table_column":"nomor","destination_table_display_column":"nomor","destination_table_display_more_column":["nomor"]}',
                    'order' => 2,
                ),
                2 => 
                array (
