...
class BeritaAcaraCRUDDataRowAdded extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        try {
            ...
            \DB::table('badaso_data_rows')->insert(array (
                ...
                array (
                    'data_type_id' => $data_type->id,
                    'field' => 'surat_perintah',
                    'type' => 'relation',
                    'display_name' => 'Surat Perintah',
                    'required' => 0,
                    'browse' => 1,
                    'read' => 1,
                    'edit' => 1,
                    ...
                    'delete' => 1,
                    'details' => '{}',
                    'relation' => '{"relation_type":"belongs_to","destination_table":"surat_perintah_operasi","destination_table_column":"nomor","destination_table_display_column":"nomor","destination_table_display_more_column":["nomor"]}',
                    'order' => 2,
                ),
                2 => 
                array (
                    'data_type_id' => $data_type->id,
                    'field' => 'tgl_berita_acara',
                    'type' => 'date',
                    'display_name' => 'Tgl Berita Acara',
                    'required' => 1,
                    'browse' => 1,
                    'read' => 1,
                    'edit' => 1,
